...
rc.rotate_until_heading(45, 45) #rotate at 45 deg/s to a heading of 45 degrees
rc.sleep(2) #Stop for 2 seconds
rc.move_until_index(2, 0.1, 93) #Move at 2 m/s with 0.1g acceleration to index 93
